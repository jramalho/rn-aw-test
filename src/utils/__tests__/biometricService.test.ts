...
const mockRNBiometrics = ReactNativeBiometrics as jest.Mocked<typeof ReactNativeBiometrics>;
...
describe('biometricService', () => {
  ...
  describe('checkBiometricAvailability', () => {
    ...
    it('should handle errors gracefully', async () => {
      const mockInstance = {
        isSensorAvailable: jest.fn().mockRejectedValue(new Error('Sensor check failed')),
      };
      (mockRNBiometrics as any).mockImplementation(() => mockInstance);
  ...
  describe('getBiometricTypeName', () => {
    ...
    it('should return "Fingerprint" for Biometrics type', () => {
      expect(getBiometricTypeName(BiometryTypes.Biometrics)).toBe('Fingerprint');
    });
